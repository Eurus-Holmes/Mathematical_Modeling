...
% .   经过我曲线拟合检验。。。貌似书上不对。。。
x0=liu(1:11)
y0=nihe1{1}(1)*x0+nihe1{1}(2)
y1=nihe1{2}(1)*x0.^2+nihe1{2}(2)*x0+nihe1{2}(3)
subplot(1,2,1),plot(liu(1:11),y(1:11),'o',x0,y0,'r')
subplot(1,2,2),plot(liu(1:11),y(1:11),'o',x0,y1,'r')
%
