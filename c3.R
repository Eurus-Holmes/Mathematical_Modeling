...
consumption<-read.xlsx(file = "/Users/chenfeiyang/2018MCM_C/total end-use consumption.xlsx",sheetIndex = 1,header=TRUE)
View(consumption)
...
production<-read.xlsx(file = "/Users/chenfeiyang/2018MCM_C/production.xlsx",sheetIndex = 1,header=TRUE)
View(production)
...
electricity<-read.xlsx(file = "/Users/chenfeiyang/2018MCM_C/Net Electricity Generation by source.xlsx",sheetIndex = 1,header=TRUE)
View(electricity)
...
Total_consumption<-read.xlsx(file = "/Users/chenfeiyang/2018MCM_C/Total end-use energy consumption.xlsx",sheetIndex = 1,header=TRUE)
...
Total_production<-read.xlsx(file = "/Users/chenfeiyang/2018MCM_C/Total energy production.xlsx",sheetIndex = 1,header=TRUE)
...
states_2009<-read.xlsx(file = "/Users/chenfeiyang/2018MCM_C/2009.xlsx",sheetIndex = 1,header=TRUE)
View(states_2009)
criteria<-read.xlsx(file = "/Users/chenfeiyang/2018MCM_C/criteria.xlsx",sheetIndex = 1,header=TRUE)
View(criteria)
